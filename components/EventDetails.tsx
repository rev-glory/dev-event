...
const EventDetails = async ({params} : {params: Promise<string>}) => {
  ...
  const {event : {description,_id, image, overview, date, time, location, mode, agenda, audience, tags, organizer}} = await response.json();
  ...
  // try {
  //   if (Array.isArray(agenda) && typeof agenda[0] === "string") {
  //     agendaArray = JSON.parse(agenda[0]);
  //   }
  // } catch (error) {
